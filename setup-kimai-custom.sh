...
echo "=== Einrichtung der Kimai Testumgebung ==="
...
docker build --no-cache -t kimai/kimai2:custom .
...
echo -e "\nUm auf einen Container zuzugreifen:"
echo "  docker exec -it $KIMAI_CONTAINER bash"
echo -e "\nDas lokale Kimai Repo wurde unter /opt/kimai gemounted"
echo -e "\nUm deine Plugins zu entwickeln, siehe README.md."
